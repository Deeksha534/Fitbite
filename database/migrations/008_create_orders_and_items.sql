-- ==============================================================================
-- Migration: 008_create_orders_and_items.sql
...
COMMENT ON TABLE public.orders IS 'Canonical store orders with financial totals, delivery snapshots, and status tracking.';
COMMENT ON COLUMN public.orders.shipping_address_snapshot IS 'Frozen JSON snapshot of delivery address at the exact moment of order placement.';
