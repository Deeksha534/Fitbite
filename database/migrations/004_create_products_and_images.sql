-- ==============================================================================
-- Migration: 004_create_products_and_images.sql
-- Description: Creates the products catalog table and the product_images
--              gallery table supporting multiple images per item.
-- ==============================================================================
...
COMMENT ON TABLE public.product_images IS 'Gallery images for products with display order and primary flag.';
